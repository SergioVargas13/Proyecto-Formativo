    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => 'Registro Panaderia',
                    'icon' =>  'fas fa-adjust',
                    'route'  => 'panaderia.index',
                ],
                [
                ...
                [
                    ...
                    'icon' =>  'fas fa-adjust',
                    'route'  => 'gestion_usuario.index',
                ],
                [
                    'text' => 'Gestión de Materia Prima',
                    'icon' =>  'fas fa-adjust',
                ...
                [
                    ...
                    'icon' =>  'fas fa-adjust',
                    'route'  => 'mano_de_obra.index',
                ],
                [
                    'text' => 'Producto Terminado',
                    'icon' =>  'fas fa-adjust',
                    'route'  => 'producto_terminado.index',
                ],
                [
                    'text' => 'Gestión de Ficha Tecnica',
                    'icon' =>  'fas fa-adjust',
                    'route'  => 'ficha_tecnica.index',
                ],
                [
                    'text' => 'Gestión de Cifs',
                    'icon' =>  'fas fa-adjust',
                    'route'  => 'cifs.index',
                ],
